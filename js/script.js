...
function setRigth(year,yue,day, isTd){
	//先清空
	...
	if(isTd){
		window.location.href = "show.php?date=" + year + '-' + yue + '-' + day;
	}
}
...
function setA(){
	...
	for(var i=0;i<arr.length;i++){
		...
		var datearr=date.split("-");
			...
			arr[i].setAttribute("onclick","javascript:setRigth("+datearr[0]+","+datearr[1]+","+datearr[2]+",1);javascript:stopBubble(this);");
			}
